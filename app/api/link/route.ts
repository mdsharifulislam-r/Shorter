...
export async function POST(Request:Request) {
    try {
        await pool.execute('CREATE TABLE IF NOT EXISTS links (link_id int not null AUTO_INCREMENT PRIMARY KEY,long_link varchar(2000), short_link varchar(256),short varchar(256),publish_date varchar(256))')
